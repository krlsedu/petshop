...
import br.com.cursojava.petshop.dto.DetalheErroDTO;
import br.com.cursojava.petshop.dto.ErroDTO;
...
public class InterceptadorDeExcecao {
    ...
    public ResponseEntity<ErroDTO> erroGeral(RuntimeException exception) {
        ...
        if (exception instanceof PetShopException) {
            erroDTO.setStatusCode(((PetShopException) exception).getStatusCode());
        } else {
